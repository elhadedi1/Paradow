          ...
          <div class="box-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">{{$data->offer}}</td>
                <td class="text-center">
                   <a href="{{url('admin/offer/'.$data->id)}}">Show Details</a>
</td>

                <td class="text-center"> {{ $data->created_at }}</td>
                <td class="text-center"> {{ $data->updated_at }}</td>
                   <td class="text-center">
                 <a href="{{url('admin/offer/'.$data->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
               </td>
                <td class="text-center">
                  <form method="post" action="{{url('admin/offer/'.$data->id)}}">
                  {{csrf_field()}}
