          ...
          <div class="box-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">{{$notification->data['mobile']}}</td>
                <td class="text-center">{{$notification->data['address']}}</td>
                <td class="text-center">{{$notification->data['msgTitle']}}</td>
                <td class="text-center">{{$notification->data['msgContent']}}</td>
