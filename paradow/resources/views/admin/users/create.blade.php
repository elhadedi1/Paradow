              ...
              <br>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form id="jvalidate" enctype="multipart/form-data" role="form" class="form-horizontal" action="{{url('admin/users')}}"  method="post" novalidate="novalidate">
...
<div class="form-check">
  ...
  <div class="form-group row @if($errors->has('photo')) has-error @endif">
    ...
    <div class="col-sm-6">
      <input type="file" class="form-control" id="inputPassword" name="photo">
  ...
  <div class="form-group row @if($errors->has('phone')) has-error @endif">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="inputPassword" placeholder="phone" name="phone">
  ...
  <div class="form-group row @if($errors->has('city')) has-error @endif">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="inputPassword" placeholder="creditNo" name="creditNo">
