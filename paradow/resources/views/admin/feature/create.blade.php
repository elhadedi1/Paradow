...
<div class="breadcrumbs">
            <div class="breadcrumbs-inner">
              ...
              <div class="col-sm-6">
              <input type="text" class="form-control" name="title[{{$key}}]" placeholder="{{$value['name']}}">
  ...
  <div class="form-group row @if($errors->has('description')) has-error @endif">
    ...
    <div class="col-sm-6">
      <textarea type="text" class="form-control" id="description" name="description[{{$key}}]" placeholder="{{$value['name']}}" row="4"></textarea>
