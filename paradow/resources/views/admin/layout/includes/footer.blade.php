    ...
    <!-- /#right-panel -->
        ...
        <script src="{{asset('/ElaAdmin-master/assets/js/jquery.min.js')}}"></script>
  ...
  "use strict";
        ...
        $(".btn_to_add").click(function(){
         ...
         var Title=["what","who","where","when"];
         var optionText=$(".txt_to_add").val();
         Title.push(optionText); 
           (i=0;i< count(Title) ;$i++){
            $("#select").append(new Option(Title[i],Title[i]));
